...
const contentRows = [
  ...
  ["GDM-47-2A", "Short", "Mystery", "Where Is the Bell?", "where-is-the-bell", "lessons/where-is-the-bell/level-3.txt"],
  ["GDM-47-2A", "Short", "Mystery", "The Little Door, Part 1", "graded-story", "lessons/graded-story/level-3.txt"],
  ["NH2-2-1-3-SVOO", "Short", "Human Drama", "Rina's Brother", "rina-brother", "lessons/rina-brother/level-3.txt"],
  ["GDM-47-2B", "Short", "Human Drama", "The Quiet Bread Shop", "bread-shop", "lessons/bread-shop/level-3.txt"],
  ["GDM-60-2", "Long", "Human Drama", "The Rainy Club Map", "rainy-club-map", "lessons/rainy-club-map/level-7.txt"],
  ["GDM-60-2", "Short", "SF", "The Star Bus", "star-bus", "lessons/star-bus/level-3.txt"],
  ["GDM-64B", "Long", "Fantasy", "Can the Clock Sing?", "can-clock-sing", "lessons/can-clock-sing/level-7.txt"],
  ["GDM-106", "Long", "Comedy", "Can the Principal Dance?", "principal-dance", "lessons/principal-dance/level-7.txt"],
  ["GDM-49-2", "Short", "Comedy", "The Wrong Robot", "wrong-robot", "lessons/wrong-robot/level-3.txt"],
  ["GDM-60-2", "Long", "Human Drama", "Don't Be a Hero", "dont-be-a-hero", "lessons/dont-be-a-hero/level-7.txt"],
  ["GDM-58-1", "Short", "Mystery", "The Window Note", "window-note", "lessons/window-note/level-3.txt"],
  ["GDM-60-2", "Short", "Fantasy", "The Moon Cup", "moon-cup", "lessons/moon-cup/level-3.txt"],
  ["GDM-60-2", "Long", "Human Drama", "The Rainy Club Map", "rainy-club-map", "lessons/rainy-club-map/level-7.txt"],
  ["GDM-64B", "Long", "Fantasy", "Can the Clock Sing?", "can-clock-sing", "lessons/can-clock-sing/level-7.txt"],
  ["GDM-47-2B", "Short", "Human Drama", "The Quiet Bread Shop", "bread-shop", "lessons/bread-shop/level-3.txt"],
  ["GDM-60-2", "Long", "Comedy", "The Gift Lesson", "gift-lesson", "lessons/gift-lesson/level-7.txt"],
  ["GDM-49-2", "Short", "Comedy", "The Wrong Robot", "wrong-robot", "lessons/wrong-robot/level-3.txt"],
  ["GDM-60-2", "Long", "Comedy", "Because the Hat Said No", "hat-said-no", "lessons/hat-said-no/level-7.txt"],
  ["GDM-60-2", "Long", "Human Drama", "Don't Be a Hero", "dont-be-a-hero", "lessons/dont-be-a-hero/level-7.txt"],
  ["GDM-60-2", "Long", "Comedy", "The Gift Lesson", "gift-lesson", "lessons/gift-lesson/level-7.txt"],
  ["GDM-60-2", "Short", "Fantasy", "The Moon Cup", "moon-cup", "lessons/moon-cup/level-3.txt"],
  ["GDM-60-2", "Long", "Fantasy / Adventure", "The Dice Gate", "dice-gate", "lessons/dice-gate/level-7.txt"],
  ["GDM-47-2B", "Short", "Human Drama", "The Quiet Bread Shop", "bread-shop", "lessons/bread-shop/level-3.txt"],
  ["GDM-60-2", "Long", "Comedy", "The Gift Lesson", "gift-lesson", "lessons/gift-lesson/level-7.txt"],
  ["GDM-47-4", "Long", "Comedy", "The Cake Was Moved", "cake-was-moved", "lessons/cake-was-moved/level-7.txt"],
  ["GDM-49-2", "Long", "Adventure", "The Red Pin Parade", "red-pin-parade", "lessons/red-pin-parade/level-7.txt"],
  ["GDM-60-2", "Long", "Adventure", "The Old Book Signal", "old-book-signal", "lessons/old-book-signal/level-7.txt"],
  ["GDM-58-2B", "Long", "Adventure", "The Pens in the Water", "pens-in-water", "lessons/pens-in-water/level-7.txt"],
  ["GDM-58-1", "Long", "Adventure", "The Map Under the Stage", "map-under-stage", "lessons/map-under-stage/level-7.txt"],
  ["GDM-46", "Long", "Adventure", "The Door Under the Stage", "door-under-stage", "lessons/door-under-stage/level-7.txt"],
  ["GDM-106", "Long", "Adventure", "Family Photo Day", "family-photo-day", "lessons/family-photo-day/level-7.txt"],
  ["GDM-106", "Long", "Adventure", "The Letter Under the Door", "letter-under-door", "lessons/letter-under-door/level-7.txt"],
  ["GDM-106", "Long", "Adventure", "Why the Lights Blink", "why-lights-blink", "lessons/why-lights-blink/level-7.txt"],
  ["GDM-48", "Long", "Adventure", "Because of the Soup", "because-of-soup", "lessons/because-of-soup/level-7.txt"],
  ["GDM-58-2B", "Long", "Adventure", "How to Open the Box", "open-the-box", "lessons/open-the-box/level-7.txt"],
  ["GDM-47-3", "Long", "Adventure", "More Than Half", "more-than-half", "lessons/more-than-half/level-7.txt"],
  ["GDM-47-2A", "Short", "Adventure", "The Travel Ticket", "travel-ticket", "lessons/travel-ticket/level-3.txt"],
  ["GDM-47-2A", "Short", "Adventure", "Maybe at the Window", "maybe-window", "lessons/maybe-window/level-3.txt"],
  ["GDM-58-2B", "Short", "Adventure", "The Should Sign", "should-sign", "lessons/should-sign/level-3.txt"],
  ["GDM-47-2A", "Short", "Adventure", "The Have-To Key", "have-to-key", "lessons/have-to-key/level-3.txt"],
  ...
  ["GDM-47-2A", "Short", "Adventure", "Can the Lantern Fly?", "can-lantern", "lessons/can-lantern/level-3.txt"],
  ["GDM-47-3", "Short", "Adventure", "Don't Be Late", "dont-be-late", "lessons/dont-be-late/level-3.txt"],
  ["GDM-106", "Long", "Adventure", "Show Me the Seat", "show-me-the-seat", "lessons/show-me-the-seat/level-7.txt"],
  ["GDM-47-2A", "Short", "SF", "The Signal Under Water", "signal-under-water", "lessons/signal-under-water/level-3.txt"],
  ["GDM-47-2A", "Short", "SF", "The Orbit Note", "orbit-note", "lessons/orbit-note/level-3.txt"],
  ["GDM-47-2A", "Short", "SF", "Why the Moon Robot Stops", "why-moon-robot", "lessons/why-moon-robot/level-3.txt"],
  ["GDM-47-2A", "Short", "SF", "Maybe at the Mars Window", "maybe-mars-window", "lessons/maybe-mars-window/level-3.txt"],
  ["GDM-60-2", "Long", "SF", "The Station Was Moved", "station-was-moved", "lessons/station-was-moved/level-7.txt"],
  ["GDM-64B", "Long", "Mystery", "Where the Roof Door Opens", "where-the-roof-door", "lessons/where-the-roof-door/level-7.txt"],
  ["GDM-106", "Long", "Mystery", "The Traveling Shadow Ticket", "traveling-shadow-ticket", "lessons/traveling-shadow-ticket/level-7.txt"],
  ["GDM-106", "Long", "Mystery", "Because the Wall Listened", "because-the-wall-listened", "lessons/because-the-wall-listened/level-7.txt"],
  ["GDM-58-1", "Long", "Mystery", "How to Read the Stone", "how-to-read-the-stone", "lessons/how-to-read-the-stone/level-7.txt"],
  ["GDM-106", "Long", "Mystery", "More Than One Moon", "more-than-one-moon", "lessons/more-than-one-moon/level-7.txt"],
  ["GDM-60-2", "Very Long", "Mystery", "The Locked Umbrella Room", "locked-umbrella-room", "lessons/locked-umbrella-room/level-8.txt"],
  ["GDM-79A", "Very Long", "Human Drama", "The Last Seat at the Table", "last-seat-table", "lessons/last-seat-table/level-8.txt"],
  ["GDM-106", "Very Long", "SF", "The Library That Was Moved", "library-moved", "lessons/library-moved/level-8.txt"],
  ["GDM-106", "Very Long", "Fantasy", "The Moon Lantern Path", "moon-lantern-path", "lessons/moon-lantern-path/level-8.txt"],
  ["GDM-64B", "Very Long", "Adventure", "The Folded Map Race", "folded-map-race", "lessons/folded-map-race/level-8.txt"],
  ["GDM-106", "Very Long", "Comedy", "The Pudding Case", "jaio-pudding-case", "lessons/jaio-pudding-case/level-8.txt"],
  ["GDM-64B", "Short", "Mystery", "Another Door Opens", "another-door-opens", "lessons/another-door-opens/level-3.txt"],
  ["GDM-79A", "Short", "SF", "Echo on the Moon", "echo-on-the-moon", "lessons/echo-on-the-moon/level-3.txt"],
  ["GDM-58-1", "Short", "Human Drama", "Inside the Kite", "inside-the-kite", "lessons/inside-the-kite/level-3.txt"],
  ["NH2-2-3-1-SHOULD", "Short", "Comedy", "Jiro's Quiet Joke", "jiro-quiet-joke", "lessons/jiro-quiet-joke/level-3.txt"],
  ["GDM-58-2B", "Short", "Adventure", "Kaito's Key Map", "kaito-key-map", "lessons/kaito-key-map/level-3.txt"],
  ["GDM-60-2", "Short", "Fantasy / Adventure", "Noa and the Night Door", "noa-night-door", "lessons/noa-night-door/level-3.txt"],
  ["GDM-79A", "Short", "Mystery", "Under the Red Desk", "under-red-desk", "lessons/under-red-desk/level-3.txt"],
  ["GDM-58-1", "Short", "Mystery", "Voices in the Wall", "voices-in-wall", "lessons/voices-in-wall/level-3.txt"],
  ["GDM-58-2B", "Short", "Adventure", "X Marks the Lunch Box", "x-marks-lunch-box", "lessons/x-marks-lunch-box/level-3.txt"],
  ["GDM-60-2", "Short", "Human Drama", "Yuna's Thank-You Note", "yuna-thank-you-note", "lessons/yuna-thank-you-note/level-3.txt"],
  ["GDM-47-2A", "Short", "SF", "Zero at the Station", "zero-at-station", "lessons/zero-at-station/level-3.txt"],
  ["GDM-60-2", "Short", "SF", "Green Glass Signal", "green-glass-signal", "lessons/green-glass-signal/level-3.txt"],
  ["GDM-44", "Short", "Human Drama", "Lost Library Card", "lost-library-card", "lessons/lost-library-card/level-3.txt"],
  ["GDM-58-2B", "Short", "Comedy", "Open on Monday", "open-on-monday", "lessons/open-on-monday/level-3.txt"],
  ["NH1-1-7-V", "Short", "Fantasy", "Paper Star Plan", "paper-star-plan", "lessons/paper-star-plan/level-3.txt"],
  ["GDM-106", "Short", "Mystery", "Quiet Question", "quiet-question", "lessons/quiet-question/level-3.txt"],
];
