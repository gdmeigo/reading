...
const contentRows = [
  ...
  ["GDM-1", "Long", "Comedy", "The Red Pin Parade", "red-pin-parade", "lessons/red-pin-parade/level-7.txt"],
  ["GDM-10", "Long", "Mystery", "The Old Book Signal", "old-book-signal", "lessons/old-book-signal/level-7.txt"],
  ["GDM-22", "Long", "Mystery", "The Pens in the Water", "pens-in-water", "lessons/pens-in-water/level-7.txt"],
  ["GDM-37-4", "Long", "Mystery", "The Map Under the Stage", "map-under-stage", "lessons/map-under-stage/level-7.txt"],
  ["GDM-41-10", "Long", "Mystery", "The Door Under the Stage", "door-under-stage", "lessons/door-under-stage/level-7.txt"],
  ["NH1-0-FAMILY", "Long", "Human Drama", "Family Photo Day", "family-photo-day", "lessons/family-photo-day/level-7.txt"],
  ["NH1-1-6-V", "Long", "Mystery", "The Letter Under the Door", "letter-under-door", "lessons/letter-under-door/level-7.txt"],
  ["NH1-1-8-3-WHY", "Long", "SF", "Why the Lights Blink", "why-lights-blink", "lessons/why-lights-blink/level-7.txt"],
  ["NH2-2-2-4-BECAUSE", "Long", "Comedy", "Because of the Soup", "because-of-soup", "lessons/because-of-soup/level-7.txt"],
  ["NH2-2-5-1-HOW-TO", "Long", "Mystery", "How to Open the Box", "open-the-box", "lessons/open-the-box/level-7.txt"],
  ["NH2-2-6-MORE-THAN", "Long", "Human Drama", "More Than Half", "more-than-half", "lessons/more-than-half/level-7.txt"],
  ["NH1-1-10-V", "Short", "Human Drama", "The Travel Ticket", "travel-ticket", "lessons/travel-ticket/level-3.txt"],
  ["NH1-1-11-1-MAYBE", "Short", "Mystery", "Maybe at the Window", "maybe-window", "lessons/maybe-window/level-3.txt"],
  ["NH2-2-3-1-SHOULD", "Short", "Comedy", "The Should Sign", "should-sign", "lessons/should-sign/level-3.txt"],
  ["NH2-2-4-1-HAVE-TO", "Short", "Mystery", "The Have-To Key", "have-to-key", "lessons/have-to-key/level-3.txt"],
  ["NH2-2-7-2-VOICE", "Short", "Mystery", "The Poster Was Moved", "passive-poster", "lessons/passive-poster/level-3.txt"],
  ["NH1-1-1-V", "Short", "Comedy", "The Drink and Read Race", "drink-read-race", "lessons/drink-read-race/level-3.txt"],
  ["NH1-1-3-CAN-Q", "Short", "Fantasy", "Can the Lantern Fly?", "can-lantern", "lessons/can-lantern/level-3.txt"],
  ["NH1-1-5-2-DONTBE", "Short", "Human Drama", "Don't Be Late", "dont-be-late", "lessons/dont-be-late/level-3.txt"],
  ["NH2-2-1-3-SVOO", "Long", "Comedy", "Show Me the Seat", "show-me-the-seat", "lessons/show-me-the-seat/level-7.txt"],
];
