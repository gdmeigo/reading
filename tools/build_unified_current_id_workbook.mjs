...
const progressRows = [
  ...
  ["NH1-1-7-V", "NH1", 11, "1-7", "know / make / buy", "一般動詞", "知る、作る、買うを使う。", "NH1画像転記"],
  ["NH1-1-8-3-WHY", "NH1", 12, "1-8-3", "Why", "疑問詞", "理由を問うことで次の展開を作る。", "NH1画像転記"],
  ["NH1-1-10-V", "NH1", 13, "1-10", "travel / visit / listen / spend / stand / feel / get up", "一般動詞", "外出・訪問・気持ちを扱う。", "NH1画像転記"],
  ["NH1-1-11-1-MAYBE", "NH1", 14, "1-11-1", "maybe", "副詞", "推測を入れてミステリー感を作る。", "NH1画像転記"],
  ["NH2-2-1-3-SVOO", "NH2", 15, "2-1-3", "SVOO: show / teach / give", "文型", "誰が誰に何をするかを明確にする。", "NH2画像転記"],
  ["NH2-2-2-4-BECAUSE", "NH2", 16, "2-2-4", "because", "接続詞", "理由を本文の中で説明する。", "NH2画像転記"],
  ["NH2-2-3-1-SHOULD", "NH2", 17, "2-3-1", "should", "助動詞", "助言や判断を話の転機に使う。", "NH2画像転記"],
  ["NH2-2-4-1-HAVE-TO", "NH2", 18, "2-4-1", "have to", "助動詞相当", "しなければならない理由を作る。", "NH2画像転記"],
  ["NH2-2-5-1-HOW-TO", "NH2", 19, "2-5-1", "how to do", "疑問詞 + 不定詞", "方法を知ることが解決につながる話。", "NH2画像転記"],
  ["NH2-2-6-MORE-THAN", "NH2", 20, "2-6", "more than / half", "比較", "数や量の比較を使う。", "NH2画像転記"],
  ["NH2-2-7-2-VOICE", "NH2", 21, "2-7-2", "受け身", "何が誰によって行われたかを説明する。", "NH2画像転記"],
];

const contentRows = [
  ["GDM-41-10", "Very Short", "Mystery", "The Little Door", "graded-story", "lessons/graded-story/level-1.txt"],
  ["GDM-41-10", "Very Short", "Human Drama", "The Blue Lunch Box", "blue-lunch-box", "lessons/blue-lunch-box/level-1.txt"],
  ["GDM-41-10", "Very Short", "Human Drama", "The Quiet Bread Shop", "bread-shop", "lessons/bread-shop/level-1.txt"],
  ["NH1-1-11-1-MAYBE", "Very Short", "SF", "The Star Bus", "star-bus", "lessons/star-bus/level-1.txt"],
  ["GDM-41-10", "Very Short", "Fantasy", "The Silver Stone", "silver-stone", "lessons/silver-stone/level-1.txt"],
  ["GDM-41-10", "Very Short", "Adventure", "The Red Bag Path", "red-bag-path", "lessons/red-bag-path/level-1.txt"],
  ["NH1-1-8-3-WHY", "Very Short", "Comedy", "The Wrong Robot", "wrong-robot", "lessons/wrong-robot/level-1.txt"],
