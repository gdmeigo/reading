...
write(howTo, 3, 0, [
  ...
  ["本文量", "Shortは現Level 3程度、Longは現Level 7程度の長さを目安にする。"],
...
write(request, 3, 0, [
  ...
  ["Length", "Short", "Short / Long", "Short=現Level 3程度、Long=現Level 7程度"],
...
write(prompt, 3, 0, [
  ...
  ["本文量", "{Length} で生成する。Shortは現Level 3程度、Longは現Level 7程度。"],
