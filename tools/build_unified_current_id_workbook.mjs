...
const contentRows = [
  ...
  ["NH1-1-3-CAN-Q", "Long", "Comedy", "Can the Principal Dance?", "principal-dance", "lessons/principal-dance/level-7.txt"],
  ...
  ["NH2-2-2-4-BECAUSE", "Long", "Comedy", "Because the Hat Said No", "hat-said-no", "lessons/hat-said-no/level-7.txt"],
