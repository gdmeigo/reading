...
const GLOSSARY_NOTES = [
  ...
  { headword: "backward", terms: ["backward"], note: "toward the back; the opposite way" },
  ...
  { headword: "brass", terms: ["brass"], note: "a yellow metal" },
  { headword: "brave", terms: ["brave"], note: "not afraid; ready to do something hard" },
  { headword: "calligraphy", terms: ["calligraphy"], note: "beautiful writing with a brush or pen" },
  { headword: "ceiling", terms: ["ceiling"], note: "the top inside part of a room" },
  { headword: "committee", terms: ["committee"], note: "a group that does a special job" },
  { headword: "confused", terms: ["confused"], note: "not able to understand clearly" },
  { headword: "crooked", terms: ["crooked"], note: "not straight" },
  ...
  { headword: "die", terms: ["die", "dice"], note: "a small cube used in a game" },
  ...
  { headword: "embarrassed", terms: ["embarrassed"], note: "feeling shy or bad because others see a mistake" },
  { headword: "engineer", terms: ["engineer", "engineers"], note: "a person who makes or fixes machines or systems" },
  ...
  { headword: "guard", terms: ["guard", "guards"], note: "a person who watches or protects a place" },
  { headword: "handle", terms: ["handle", "handles"], note: "the part you hold to open or carry something" },
  { headword: "haunted", terms: ["haunted"], note: "with a ghost or a scary feeling" },
  { headword: "hill", terms: ["hill", "hills"], note: "a small high place of land" },
  { headword: "impossible", terms: ["impossible"], note: "not possible; cannot be done" },
  { headword: "invitation", terms: ["invitation"], note: "a message asking someone to come" },
  { headword: "kindness", terms: ["kindness"], note: "being good and helpful to others" },
  ...
  { headword: "mayor", terms: ["mayor"], note: "the leader of a town or city" },
  ...
  { headword: "narrow", terms: ["narrow"], note: "not wide" },
  { headword: "notebook", terms: ["notebook", "notebooks"], note: "a book for writing notes" },
  { headword: "orbit", terms: ["orbit"], note: "the path of one thing around another in space" },
  { headword: "platform", terms: ["platform", "platforms"], note: "a raised flat place at a station or on a stage" },
  { headword: "pocket", terms: ["pocket", "pockets"], note: "a small place in clothes or a bag" },
  { headword: "polite", terms: ["polite"], note: "kind and careful in how you speak or act" },
  ...
  { headword: "ribbon", terms: ["ribbon", "ribbons"], note: "a long thin piece of cloth" },
  { headword: "rival", terms: ["rival", "rivals"], note: "someone you try to beat" },
  ...
  { headword: "satellite", terms: ["satellite", "satellites"], note: "a machine or moon that moves around a planet" },
  { headword: "scissors", terms: ["scissors"], note: "a tool for cutting paper or cloth" },
  ...
  { headword: "sharp", terms: ["sharp"], note: "able to cut easily" },
  { headword: "shelf", terms: ["shelf", "shelves"], note: "a flat place on a wall for things" },
  { headword: "shrine", terms: ["shrine", "shrines"], note: "a special place for prayer" },
  { headword: "signal", terms: ["signal", "signals"], note: "a light, sound, or mark that sends a message" },
  { headword: "soldier", terms: ["soldier", "soldiers"], note: "a person in an army" },
  { headword: "station", terms: ["station", "stations"], note: "a place where trains or buses stop" },
  { headword: "statue", terms: ["statue", "statues"], note: "a shape of a person or animal made from stone or metal" },
  ...
  { headword: "treasure", terms: ["treasure"], note: "something very valuable or special" },
  { headword: "umbrella", terms: ["umbrella", "umbrellas"], note: "a thing used in rain" },
  { headword: "volunteer", terms: ["volunteer", "volunteers"], note: "a person who helps without being paid" },
  { headword: "warning", terms: ["warning", "warnings"], note: "words or signs that tell you about danger" },
  { headword: "whistle", terms: ["whistle", "whistles"], note: "a small tool that makes a loud sound when you blow it" },
];
